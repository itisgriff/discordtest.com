...
export function UserErrorDisplay({ error, retryAfter, onRetry }: UserErrorDisplayProps) {
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          <div className="mt-4 text-sm text-gray-500 dark:text-gray-400">
            <p>If you're sure the user ID is correct and this problem persists, check:</p>
            <ul className="list-disc ml-5 mt-1">
              <li>The user ID format (user IDs are usually 18-19 digits)</li>
              <li>If the user account still exists</li>
